...
def resizepad(image, targrt_size, frame=True):
    """
    Adjust the image size and perform grayscale filling
    Args:
        image (numpy.ndarray): Input image as a NumPy array.
        targrt_size (tuple): A tuple (width, height) specifying the target size.
...
if __name__=="__main__":
    image_path = r"D:\PythonProject\pyzjrPyPi\pyzjr\augmentation\transforms\fire976.jpg"
