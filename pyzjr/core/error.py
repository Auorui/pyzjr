...
__all__=["not_rgb_warning","Error_flags","Augment_Error_Message", "_check_img_is_plt", "_check_parameter_is_tuple_2", "_check_parameter_is_tuple_and_list_2", \
         "_check_parameter_is_tuple_and_list_or_single_2", "check_dtype", "_check_img_is_ndarray", "_check_input_is_tensor" ,
...
class check_dtype():
    ...
    def is_None(self):
        return self.para is None

    def is_positive_int(self):
        return self.is_int() and self.para > 0


    def is_nonnegative_int(self):
        return self.is_int() and self.para >= 0
