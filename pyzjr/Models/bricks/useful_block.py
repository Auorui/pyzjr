...
from pyzjr.Models._attention import SEAttention
from pyzjr.Models.bricks.conv_norm_act import ConvBNReLU, ConvBN, conv1x1
...
ResidualBlock = ResNetBasicBlock
...
if __name__=="__main__":
    ...
    # block = ResNetBottleneck(in_channels=64, out_channels=64, stride=1, use_se=True)
    output = block(input)
