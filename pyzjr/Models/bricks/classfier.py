...
from pyzjr.Models.sampling import SelectAdaptivePool2d
...
class ClassifierHead(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, pool_type='avg', drop_rate=0.):
        super(ClassifierHead, self).__init__()
        self.drop_rate = drop_rate
        self.global_pool, self.fc = create_classifier(in_channels, num_classes, pool_type=pool_type)
